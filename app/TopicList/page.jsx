...
//   Paper, IconButton, Tooltip, CircularProgress, Typography, Box, Button, TextField, InputAdornment
// } from "@mui/material";
// import { Edit as EditIcon, Logout as LogoutIcon, Search as SearchIcon } from "@mui/icons-material";
...
//     <Box maxWidth="lg" mx="auto" mt={4} p={2}>
//       <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
//         <Button variant="contained" color="primary" onClick={() => router.push('/addTopic')}>
//           Add Topic
//         </Button>
...
//                 {["Project Name", "Website Link", "Technology", "Description", "Page Builder",
//                   "Client Name", "Client Invoices", "Bid Platform", "Bid Platform URL",
//                   "Invoice Amount", "Project Start Date", "Completion Date", "Testimonials", "Actions"].map((header, index) => (
//                   <TableCell key={index} sx={{ fontWeight: "bold", padding: "12px" }}>
//                     {header}
//                   </TableCell>
//                 ))}
//               </TableRow>
...
//                       </IconButton>
//                     </Tooltip>
//                     <RemoveBtn id={t._id} onDeleteSuccess={(id) => setTopics(prev => prev.filter(t => t._id !== id))} />
//                   </TableCell>
//                 </TableRow>
//               ))}
//             </TableBody>
